...
// `newline` is explicit: Papa.unparse defaults to \r\n between records, which
// combined with the appended \n would leave the file with mixed terminators and
// make regeneration non-reproducible across machines.
writeFileSync(
  TARGET,
